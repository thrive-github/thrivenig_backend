...
class Booking:
    ...
    def construct_booking(self):
        ...
        offer['created'] = keep_date_remove_time(
            self.flight['associatedRecords'][0]['creationDate'])
        ...
        for f in self.flight['flightOffers'][0]['itineraries']:
            ...
            # one stop flight
            if len(self.flight['flightOffers'][0]['itineraries'][index]['segments']) == 2:
                ...
                offer[str(index) + 'firstFlightAirlineLogo'] = get_airline_logo(
                    self.flight['flightOffers'][0]['itineraries'][index]['segments'][0]['carrierCode'])
                offer[str(
                    index) + 'firstFlightAirline'] = self.flight['flightOffers'][0]['itineraries'][index]['segments'][0]['carrierCode']
                offer[str(index) + 'firstFlightDepartureDate'] = get_hour(self.flight['flightOffers']
                                                                          [0]['itineraries'][index]['segments'][0]['departure']['at'])
                offer[str(index) + 'departureDate'] = keep_date_remove_time(
                    self.flight['flightOffers'][0]['itineraries'][index]['segments'][0]['departure']['at'])
                offer[str(index) + 'firstFlightArrivalAirport'] = self.flight['flightOffers'][0]['itineraries'][index]['segments'][0]['arrival']['iataCode']
                offer[str(index) + 'firstFlightArrivalDate'] = get_hour(self.flight['flightOffers']
                                                                        [0]['itineraries'][index]['segments'][0]['arrival']['at'])
                ...
                offer[str(index) + 'secondFlightDepartureDate'] = get_hour(
                    self.flight['flightOffers'][0]['itineraries'][index]['segments'][1]['departure']['at'])
                offer[str(index) + 'secondFlightAirlineLogo'] = get_airline_logo(
                    self.flight['flightOffers'][0]['itineraries'][index]['segments'][1]['carrierCode'])
                offer[str(
                    index) + 'secondFlightAirline'] = self.flight['flightOffers'][0]['itineraries'][index]['segments'][1]['carrierCode']
                ...
                offer[str(index) + 'secondFlightArrivalDate'] = get_hour(
                    self.flight['flightOffers'][0]['itineraries'][index]['segments'][1]['arrival']['at'])

            # direct flight
            elif len(self.flight['flightOffers'][0]['itineraries'][0]['segments']) == 1:
                offer[str(index) + 'firstFlightDepartureAirport'] = self.flight['flightOffers'][0]['itineraries'][index]['segments'][0]['departure']['iataCode']
                offer[str(index) + 'firstFlightAirlineLogo'] = get_airline_logo(
                    self.flight['flightOffers'][0]['itineraries'][index]['segments'][0]['carrierCode'])
                offer[str(
